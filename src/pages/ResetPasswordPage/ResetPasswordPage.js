...
import logo from "../../assets/icons8-dead-by-daylight.svg";
    ...
    return (
      ...
      <div className="form-card text-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="form-label text-white">Repetir nueva contraseña</label>
            <div className="password-wrapper">
              <input
                type={showRepeatPassword ? "text" : "password"}
                className={`form-control ${match === null ? "" : match ? "is-valid" : "is-invalid"}`}
          ...
          <div className="d-grid gap-2">
            ...
            <button type="button" className="btn btn-outline-light" onClick={handleGoBack}>
